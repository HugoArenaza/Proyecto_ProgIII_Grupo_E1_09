...
public class VentanaJefeAgregar extends JFrame {
    ...
    private void agregarTrabajador() {
    	try {
            ...
            String consultaTrabajador = "INSERT INTO VETERINARIO (Id,nombre, apellidos, usuario, contraseña, dni, sueldo,numero_empleados,numero_pacientes, especialidad, TIPO_VETERINARIO) VALUES (?, ?, ?, ?, ?,  ?, ?, ?, ?,?,'Jefe')";
